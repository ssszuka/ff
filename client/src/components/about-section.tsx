      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-16" data-aos="fade-up">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-2nd font-bold mb-4 md:mb-6 text-white" data-testid="text-about-title">
              About the Dreamer
            </h2>
                  ...
                  >
                    <div className="flex items-center">
                      <div className={`w-10 h-10 md:w-12 md:h-12 ${badge.bg} rounded-full flex items-center justify-center mr-3 md:mr-4`}>
                        <badge.icon className="text-white w-5 h-5 md:w-6 md:h-6" />
                      </div>
                      <div>
