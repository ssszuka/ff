...
onError={(e) => {
          ...
          <div data-aos="fade-up" data-aos-delay="100">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-3 md:mb-4 gradient-text transition-all duration-500 ease-in-out" data-testid="text-hero-name">
              {displayName}
            </h1>
